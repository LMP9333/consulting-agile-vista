    ...
    <section id="top" className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 lg:px-12 pt-40 lg:pt-48 pb-24 lg:pb-32">
        <div className="max-w-3xl">
          ...
          <h1 className="reveal reveal-delay-1 font-serif text-[hsl(var(--ink-deep))] text-5xl md:text-7xl lg:text-[5.5rem] leading-[1.02] mb-8">
            Implementations that <em className="text-[hsl(var(--gold))] not-italic font-light italic">outlast</em> the software you choose.
          </h1>
          ...
          <div className="reveal reveal-delay-3 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
              className="inline-flex items-center gap-3 bg-gradient-gold text-[hsl(var(--cream))] px-8 py-4 rounded-sm text-sm uppercase tracking-[0.2em] font-medium hover:opacity-90 transition"
            >
              Start an evaluation
            ...
            <a
              href="#approach"
              className="inline-flex items-center gap-3 text-[hsl(var(--ink))] px-6 py-4 text-sm uppercase tracking-[0.2em] border border-[hsl(var(--ink))]/20 hover:border-[hsl(var(--gold))] hover:text-[hsl(var(--gold))] transition"
            >
              Our approach
            </a>
          </div>
