const Nav = () => {
  const handleScroll = (e: React.MouseEvent<HTMLAnchorElement>, id: string) => {
    e.preventDefault(); // Blocks the browser from breaking the URL structure
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-6 lg:px-12 py-6 flex items-center justify-between">
        <a href="#top" onClick={(e) => handleScroll(e, "top")} className="flex items-center gap-2">
        ...
        <nav className="hidden md:flex items-center gap-10 text-sm text-[hsl(var(--ink))]/80">
          <a href="#approach" onClick={(e) => handleScroll(e, "approach")} className="hover:text-[hsl(var(--gold))] transition-colors">Approach</a>
          <a href="#services" onClick={(e) => handleScroll(e, "services")} className="hover:text-[hsl(var(--gold))] transition-colors">Services</a>
          <a href="#industries" onClick={(e) => handleScroll(e, "industries")} className="hover:text-[hsl(var(--gold))] transition-colors">Industries</a>
          <a href="#contact" onClick={(e) => handleScroll(e, "contact")} className="hover:text-[hsl(var(--gold))] transition-colors">Contact</a>
        </nav>
        <a
          href="#contact"
